...
By using three different accounts, the project has been able to gain access to potential marketing expenses and the service design from a range of different angles. Which in return has allowed LNATS to develop target pencentages of growth through general information hand outs and basic functionality, too measure the initial time consumption of expanding the projects base layer with regular updates, questions and serveys being given to the community.
